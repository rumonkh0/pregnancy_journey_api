...
INSERT INTO `admin_role` VALUES (1,1),(2,1),(1,2),(1,5),(7,4),(7,3),(7,10),(7,11),(7,7),(8,2),(8,3),(8,8),(9,1),(9,2),(9,3),(8,1),(7,8);
...
INSERT INTO `admins` VALUES (1,'rumonkh','Rumon','Khan','rummankh0@gmail.com','$2a$12$MdFpsfQjuDZXv0QOglil/.nkExSVTboZWX./nAZ9f4B6mjLKBfemu',201,'2024-02-07 19:54:34','2024-03-29 16:21:36'),(2,'armankhan','MD Arman','Khan','armanakt@gmail.com','$2a$12$MdFpsfQjuDZXv0QOglil/.nkExSVTboZWX./nAZ9f4B6mjLKBfemu',198,'2024-02-07 19:55:13','2024-03-29 15:33:32'),(7,'selim','Selim2','vai','selim@mail.com','$2b$10$LBiZU472IiMZtegEpnnKx.hTF.qYWSGpSHGZ0kNi1RQnQTmifBMem',199,'2024-02-10 20:07:08','2024-03-29 15:34:00'),(8,'admin','King','power','admin@mail.com','$2b$10$BAULN3KdcWXmmJUeebDxmO00jki9xB5qw9YjGUfZgJhOWIOsYCq/m',200,'2024-03-04 14:49:36','2024-03-29 15:34:31'),(9,'SelimReza','Selim','Reza','selimrezaibsnal@gmail.com','$2b$10$LAz7Ur4QLL95Bla3QPxMpumVhKjqG31tx.wGxWyvQbTUI/piuIS02',197,'2024-03-11 17:23:33','2024-03-29 15:32:53');
...
INSERT INTO `baby_breast_pumping` VALUES (32,23,58,68,126,'7 minutes','9 minutes','16 minutes','2023-11-28 08:00:00','2023-11-28 17:03:24'),(33,23,58,68,2147483647,'7 minutes','9 minutes','16 minutes','2023-11-28 08:00:00','2023-11-28 17:03:36'),(35,27,5,7,12,'7 minutes','9 minutes','16 minutes','2023-11-28 08:00:00','2024-04-29 05:51:40');
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='ml';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `baby_feed` VALUES (32,23,'breast','100 minutes',NULL,NULL,100,NULL,NULL,'2023-11-28 08:00:00','2023-11-28 08:00:00','2023-11-28 16:57:45'),(33,23,'breast','100 minutes',NULL,NULL,100,NULL,NULL,'2023-11-28 08:00:00','2023-11-28 08:00:00','2023-11-28 16:58:04'),(34,23,'breast','100 minutes',NULL,NULL,100,NULL,NULL,'2023-11-28 08:00:00','2023-11-28 16:59:17','2023-11-28 16:59:17'),(35,23,'breast','10000000000000000000000000000 minutes',NULL,NULL,100,NULL,NULL,'2023-11-28 08:00:00','2023-11-28 17:02:13','2023-11-28 17:02:13'),(42,27,'breast','10000000000000000000000000000 minutes',NULL,'232 minutes',100,NULL,NULL,'2023-11-28 08:00:00','2024-02-24 18:20:26','2024-02-24 18:20:26'),(43,27,'breast','2 minutes',NULL,'5 minutes',1,NULL,NULL,'2023-11-28 08:00:00','2024-04-29 05:47:21','2024-04-29 05:47:21');
...
CREATE TABLE `baby_growth` (
  ...
  PRIMARY KEY (`id`),
  KEY `baby_id` (`baby_id`),
  CONSTRAINT `baby_growth_ibfk_1` FOREIGN KEY (`baby_id`) REFERENCES `baby_list` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `baby_growth`
--

LOCK TABLES `baby_growth` WRITE;
/*!40000 ALTER TABLE `baby_growth` DISABLE KEYS */;
INSERT INTO `baby_growth` VALUES (6,27,1,2500,45,'2024-04-11 19:33:05','2024-04-11 19:33:05'),(7,27,2,2600,46,'2024-04-11 19:33:05','2024-04-11 19:33:05'),(8,27,3,2700,47,'2024-04-11 19:33:05','2024-04-11 19:33:05'),(9,27,4,2800,48,'2024-04-11 19:33:05','2024-04-11 19:33:05'),(10,27,5,2900,49,'2024-04-11 19:33:05','2024-04-11 19:33:05');
/*!40000 ALTER TABLE `baby_growth` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `baby_growth_dev`
--

DROP TABLE IF EXISTS `baby_growth_dev`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `baby_growth_dev` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `week` int(11) NOT NULL,
  `weight` int(11) NOT NULL,
  `height` int(11) NOT NULL,
...
--
-- Dumping data for table `baby_growth_dev`
--

LOCK TABLES `baby_growth_dev` WRITE;
/*!40000 ALTER TABLE `baby_growth_dev` DISABLE KEYS */;
INSERT INTO `baby_growth_dev` VALUES (1,1,1500,40),(2,2,1700,42),(3,3,1900,44),(4,4,2100,46),(5,5,2300,48);
/*!40000 ALTER TABLE `baby_growth_dev` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `blog_categories` VALUES (1,1,'{ \"en\": \"pregnancy\"}','{ \"en\": \"pregnancy\"}','174',NULL,NULL),(2,1,'{ \"en\": \"health\"}','{ \"en\": \"pregnancy\"}','174','2024-01-09 18:41:44','2024-01-09 18:41:44'),(3,2,'{ \"en\": \"baby\"}','{ \"en\": \"pregnancy\"}','174','2024-01-09 18:42:07',NULL),(4,3,'{ \"en\": \"food\"}','{ \"en\": \"pregnancy\"}','174','2024-01-09 18:42:38',NULL);
...
INSERT INTO `bp_trackers` VALUES (1,'right',100,80,'2024-01-09 16:42:02','2024-01-09 16:43:53',12),(2,'right',120,80,'2024-01-09 16:42:15','2024-04-29 09:13:05',12);
/*!40000 ALTER TABLE `bp_trackers` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `check_value`
--

DROP TABLE IF EXISTS `check_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `check_value` (
  `user_id` int(10) unsigned DEFAULT NULL,
  `baby_id` int(10) unsigned DEFAULT NULL,
  `check_values` text NOT NULL,
  UNIQUE KEY `user_id` (`user_id`),
  UNIQUE KEY `baby_id` (`baby_id`),
  CONSTRAINT `check_value_ibfk_1` FOREIGN KEY (`baby_id`) REFERENCES `baby_list` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `check_value_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `check_value`
--

LOCK TABLES `check_value` WRITE;
/*!40000 ALTER TABLE `check_value` DISABLE KEYS */;
INSERT INTO `check_value` VALUES (12,NULL,'[1,2,5,7]'),(NULL,23,'[1,4,2,7]');
/*!40000 ALTER TABLE `check_value` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `checklist` VALUES (1,1,2,'eat healthy today','2024-04-08 11:00:08','2024-04-08 11:00:08'),(2,1,1,'exercise','2024-04-08 11:00:19','2024-04-08 11:00:19'),(3,1,3,'do something','2024-04-08 11:00:35','2024-04-08 11:00:35');
...
INSERT INTO `checklist_item` VALUES (1,'mother',1,'week1','2024-04-05 15:31:05','2024-04-05 15:31:05'),(2,'mother',2,'week2','2024-04-05 15:31:28','2024-04-05 15:31:28');
/*!40000 ALTER TABLE `checklist_item` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `checklist_subitem`
--

DROP TABLE IF EXISTS `checklist_subitem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `checklist_subitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `item` (`item`),
  CONSTRAINT `checklist_subitem_ibfk_1` FOREIGN KEY (`item`) REFERENCES `checklist_item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `checklist_subitem`
--

LOCK TABLES `checklist_subitem` WRITE;
/*!40000 ALTER TABLE `checklist_subitem` DISABLE KEYS */;
INSERT INTO `checklist_subitem` VALUES (1,1,'new subitem dropdown',1,'2024-04-05 15:47:01','2024-04-05 15:47:01'),(2,1,'new dropdown',2,'2024-04-05 15:47:25','2024-04-05 15:47:25');
/*!40000 ALTER TABLE `checklist_subitem` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `comments` VALUES (1,12,3,NULL,0,0,'this is a large content','2023-12-14 12:52:57','2023-12-14 12:52:57'),(3,12,3,NULL,1,0,'this is a last content','2023-12-14 12:53:17','2024-03-22 17:13:08'),(4,12,3,NULL,0,0,'this is a checking content','2023-12-14 12:55:38','2023-12-14 12:55:38'),(5,12,2,NULL,0,0,'this is a checking content','2023-12-14 13:20:23','2023-12-14 13:20:23'),(6,12,47,NULL,0,0,'this is another comment','2024-03-11 15:42:10','2024-03-11 15:42:10'),(7,12,47,NULL,0,0,'this is another test ','2024-03-11 15:42:25','2024-03-11 15:42:25'),(20,12,46,NULL,1,6,'this is another test ','2024-03-15 16:24:28','2024-03-22 17:40:00'),(21,12,46,NULL,0,1,'this is another test ','2024-03-15 16:24:28','2024-03-22 17:51:24'),(22,12,46,NULL,0,0,'this is another test ','2024-03-15 16:24:29','2024-03-15 16:24:29'),(23,12,46,NULL,0,0,'this is another test ','2024-03-15 16:24:29','2024-03-15 16:24:29'),(24,12,46,NULL,0,0,'this is another test ','2024-03-15 16:43:20','2024-03-15 16:43:20'),(25,12,46,NULL,0,0,'this is another test ','2024-03-16 16:20:10','2024-03-16 16:20:10'),(29,12,NULL,20,0,0,'this is another reply test ','2024-03-16 16:48:52','2024-03-22 17:14:35'),(30,12,NULL,20,0,0,'this is another reply test ','2024-03-22 16:50:17','2024-03-22 16:50:17'),(31,12,47,NULL,0,0,'this is another test ','2024-03-22 17:07:58','2024-03-22 17:13:12'),(32,12,NULL,31,0,0,'notun reply ','2024-03-22 17:11:15','2024-03-22 17:11:15'),(33,12,NULL,31,0,0,'this is another reply test ','2024-03-22 17:17:10','2024-03-22 17:17:10'),(34,12,NULL,31,0,0,'this is another reply test ','2024-03-22 17:21:24','2024-03-22 17:21:24'),(36,12,NULL,20,0,0,'this is another reply test ','2024-03-22 17:33:33','2024-03-22 17:33:33'),(37,12,NULL,20,0,0,'this is another reply test ','2024-03-22 17:35:40','2024-03-22 17:35:40'),(38,12,NULL,20,0,0,'this is another reply test ','2024-03-22 17:36:40','2024-03-22 17:36:40'),(39,12,NULL,20,0,0,'this is another reply test ','2024-03-22 17:40:00','2024-03-22 17:40:00'),(40,12,46,NULL,0,0,'this is another test ','2024-03-22 17:41:02','2024-03-22 17:41:02'),(41,12,NULL,21,0,0,'this is another reply test ','2024-03-22 17:51:24','2024-03-22 17:51:24');
...
--
-- Table structure for table `daily_tips_baby`
--

DROP TABLE IF EXISTS `daily_tips_baby`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `daily_tips_baby` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `day` int(11) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `description` longtext DEFAULT NULL,
...
--
-- Dumping data for table `daily_tips_baby`
--

LOCK TABLES `daily_tips_baby` WRITE;
/*!40000 ALTER TABLE `daily_tips_baby` DISABLE KEYS */;
INSERT INTO `daily_tips_baby` VALUES (2,2,'{\"en\":\"first daily tips\",\"bn\":\"sadf\"}','{\"en\":\"first description\",\"bn\":\"asdf\"}','150','2024-03-02 04:46:03','2024-03-02 05:08:19'),(3,3,'{\"en\":\"adfadf\",\"bn\":\"notun bangla add\"}','{\"en\":\"adfadsf\",\"bn\":\"adding bangla\"}','151','2024-03-02 04:49:25','2024-03-02 05:09:13');
/*!40000 ALTER TABLE `daily_tips_baby` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `diet` VALUES (1,'pending',12,NULL,25,65,NULL,'2024-10-01 00:00:00',0,1,'2024-02-26 17:50:04','2024-02-26 17:50:04',22.5),(2,'pending',12,NULL,25,65,NULL,'2024-10-01 00:00:00',0,1,'2024-04-10 06:29:03','2024-04-10 06:29:03',22.5),(3,'pending',12,NULL,25,65,NULL,'2024-10-01 00:00:00',0,1,'2024-04-10 09:33:18','2024-04-10 09:33:18',22.5);
...
INSERT INTO `drug_reminder` VALUES (1,'Ibuprofen','200mg','8:00 AM',NULL,'2023-12-04 15:46:14',NULL,12),(2,'napa ace','200mg','8:00 AM',NULL,'2023-12-04 15:47:00',NULL,12),(3,'napa 500mg','200mg','8:00 AM','ousudh khete hobe','2024-04-10 07:59:29','2024-04-10 07:59:29',12),(4,'napa 500mg','200mg','8:00 AM','ousudh khete hobe','2024-04-17 07:29:22','2024-04-17 07:29:22',12);
...
INSERT INTO `help_desk` VALUES (1,12,NULL,'hello admin! I need help','2024-02-09 17:40:43','2024-02-09 17:40:43'),(2,12,NULL,'hello admin! are u there','2024-02-09 17:41:32','2024-02-09 17:41:32'),(7,12,7,'yes, i am there hou can i help u','2024-02-11 12:35:53','2024-02-11 12:35:53'),(9,12,NULL,'hello admin! are you there admins! I am in trouble','2024-03-08 17:12:11','2024-03-08 17:12:11'),(10,12,1,'yes, i am there hou can i help u','2024-03-08 17:49:38','2024-03-08 17:49:38'),(11,12,NULL,'hello admin! are you there admins! I am in trouble','2024-03-08 17:52:35','2024-03-08 17:52:35'),(14,12,8,'i am here buddy','2024-03-09 10:24:15','2024-03-09 10:24:15'),(15,12,8,'o mg','2024-03-09 10:25:00','2024-03-09 10:25:00'),(16,12,NULL,'oh! u replyed','2024-03-09 10:28:08','2024-03-09 10:28:08'),(17,12,8,'yes! we are always here for u','2024-03-09 10:28:26','2024-03-09 10:28:26'),(18,12,NULL,'thank you','2024-03-09 10:30:14','2024-03-09 10:30:14'),(19,12,NULL,'thank you','2024-03-09 10:32:04','2024-03-09 10:32:04'),(20,12,NULL,'thank you','2024-03-09 10:32:14','2024-03-09 10:32:14'),(22,12,8,'huh','2024-03-09 10:35:41','2024-03-09 10:35:41'),(23,12,8,'i am obsessed','2024-03-09 10:35:50','2024-03-09 10:35:50'),(24,12,8,'please help me','2024-03-09 10:35:54','2024-03-09 10:35:54'),(25,12,8,'how are you','2024-03-09 10:36:00','2024-03-09 10:36:00'),(26,12,NULL,'thank you','2024-03-09 11:32:36','2024-03-09 11:32:36'),(27,12,8,'welcome','2024-03-09 13:29:01','2024-03-09 13:29:01'),(28,12,NULL,'thank you','2024-03-09 13:44:43','2024-03-09 13:44:43'),(29,12,8,'ok','2024-03-09 13:58:58','2024-03-09 13:58:58'),(30,12,NULL,'thank you','2024-03-09 14:11:30','2024-03-09 14:11:30'),(31,111,NULL,'thank you','2024-03-09 14:16:58','2024-03-09 14:16:58'),(32,111,8,'hello how can i help u','2024-03-09 14:17:26','2024-03-09 14:17:26'),(33,111,NULL,'thank you','2024-03-09 15:24:21','2024-03-09 15:24:21'),(34,111,8,'welcome','2024-03-09 16:19:00','2024-03-09 16:19:00'),(35,12,8,'ok bye','2024-03-22 18:43:45','2024-03-22 18:43:45'),(36,12,NULL,'thank you','2024-03-22 18:44:32','2024-03-22 18:44:32');
...
INSERT INTO `notes` VALUES (7,12,'second note','All text goes here.. bye bye long text','2023-12-31 23:59:59',1,'2024-04-29 10:30:03','2024-04-29 10:30:03');
...
INSERT INTO `post_topic` VALUES (1,'Baby','Hello baby!',122,'2024-02-28 19:32:12',NULL),(2,'Mum','Hello MUM!',121,'2024-02-28 19:32:12',NULL),(3,'toodler','Topic for toodler',122,'2024-02-28 19:32:34',NULL),(4,'Random Talk','random talking topic',122,'2024-02-28 19:32:34',NULL);
...
INSERT INTO `postmedia` VALUES (21,32),(21,33),(21,34),(23,38),(23,39),(23,40),(23,41),(24,42),(24,43),(24,44),(24,45),(25,46),(25,47),(36,48),(37,49),(37,50),(45,131),(45,132),(46,133),(46,134),(47,135),(47,136),(60,186),(60,187);
...
CREATE TABLE `postnatal_visit` (
  ...
  CONSTRAINT `postnatal_visit_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `posts` VALUES (1,12,1,'hello i am first title','this is a large content',0,NULL,2,0,'2024-02-27 20:27:18','2023-12-13 17:58:37'),(3,12,1,'hello i am another title','this is a large content',0,NULL,0,0,'2023-12-13 17:59:04','2023-12-13 17:59:04'),(5,12,1,'hello i am last title','this is a large content',0,NULL,0,0,'2024-02-03 17:42:42','2024-02-03 17:42:42'),(6,12,1,'New develop ment for adding multiple images','this is a large content',0,NULL,0,0,'2024-02-03 17:43:26','2024-02-03 17:43:26'),(12,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:20:28','2024-02-04 09:20:28'),(13,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:20:41','2024-02-04 09:20:41'),(14,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:23:10','2024-02-04 09:23:10'),(15,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:23:47','2024-02-04 09:23:47'),(16,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:28:08','2024-02-04 09:28:08'),(17,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:28:55','2024-02-04 09:28:55'),(18,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:29:27','2024-02-04 09:29:27'),(19,12,1,'new title','large content',0,NULL,0,0,'2024-02-04 09:31:22','2024-02-04 09:31:22'),(20,12,1,'new title','large content',1,NULL,1,0,'2024-03-24 09:45:16','2024-02-04 09:33:57'),(45,12,1,'photo diye','2 ta photo ache',1,NULL,0,0,'2024-03-24 09:45:15','2024-02-29 19:04:07'),(46,109,3,'photo diye','2 ta photo ache',1,NULL,1,7,'2024-03-25 18:24:29','2024-02-29 19:05:23'),(47,109,3,'photo diye','2 ta photo ache',1,NULL,2,3,'2024-03-24 09:45:12','2024-02-29 19:05:47'),(57,12,3,'photo diye','2 ta photo ache',0,NULL,0,0,'2024-03-27 14:28:35','2024-03-27 14:28:35'),(60,12,3,'photo diye','2 ta photo ache',0,NULL,0,0,'2024-03-27 14:31:16','2024-03-27 14:31:16');
...
INSERT INTO `reactions` VALUES (1,1,12,3,NULL,'2023-12-14 14:41:52','2023-12-14 14:41:52'),(2,1,12,4,NULL,'2023-12-14 14:43:16','2023-12-14 14:43:16'),(5,2,12,NULL,1,'2023-12-14 15:24:51','2024-03-16 15:33:45'),(6,3,13,1,NULL,'2023-12-14 15:03:26','2023-12-14 15:05:21'),(18,3,12,2,NULL,'2024-02-27 20:21:29','2024-02-27 20:23:50'),(19,3,12,1,NULL,'2024-02-27 20:27:18','2024-02-27 20:27:24'),(21,3,111,47,NULL,'2024-03-07 16:17:19','2024-03-07 16:17:19'),(22,3,111,46,NULL,'2024-03-07 16:18:43','2024-03-07 16:18:43'),(24,3,12,465,NULL,'2024-03-07 17:13:01','2024-03-07 17:13:17'),(71,2,12,NULL,20,'2024-03-22 17:05:57','2024-03-22 17:05:57'),(73,29,12,NULL,3,'2024-03-22 17:13:08','2024-03-22 17:13:21'),(78,3,12,47,NULL,'2024-03-22 17:50:28','2024-03-22 17:50:28');
...
INSERT INTO `tool_mother_symptoms` VALUES (1,12,'Headache','Mild','Had a headache for an hour.','2023-12-04 15:13:06','2023-12-04 15:13:06'),(3,12,'Headache','so high','Had a headache for an hour.','2023-12-04 15:13:34','2023-12-04 15:13:34'),(4,12,'Headache','so low','Had a headache for an hour.','2023-12-04 15:13:40','2023-12-04 15:13:40'),(5,12,'jor','so low','Had a headache for an hour.','2024-01-09 16:31:28','2024-01-09 16:44:18'),(6,12,'Headache','sever','Had a headache for an hour.','2024-04-29 09:12:04','2024-04-29 09:12:04');
...
INSERT INTO `users` VALUES (7,NULL,'kamal','kalu','reza',28,1,139,NULL,2,'2023-12-15 00:00:00',NULL,'new1user@email.com','$2b$10$M5LSsfNStlqUq/XHRL5qS.FsRwSZ3Tsgze.569oFqgum5Q2kTbq3S','English',NULL,NULL,NULL,1,'email','general_user','Premium','2f1cbc7873708f75f944e1c39831f55cd37e0d5d4d58f900b63c66c6cfd3b286','Sun Nov 26 2023 23:02:41 GMT+0600 (Bangladesh Standard Time)600000',NULL,'0','0','2023-01-01 00:00:00',0,NULL,'2023-11-26 10:28:12','2024-03-01 17:00:55'),(12,NULL,'shapla','shapla','jahan',26,1,204,NULL,1,'2023-12-15 00:00:00',NULL,'shapla@email.com','$2b$10$a.2MqcV5L1XlcROdV2dpDOvzO9in9wMCZX2rEWiAPHP9759PgWQx.','Bangla',NULL,NULL,NULL,1,'email','general_user','Free','8d216e62a0af344ecb1efb8a6a43f1101da31e2d5c78a012f94e2a0e0dbf62b3',NULL,NULL,'1','0','2023-01-01 00:00:00',0,NULL,'2023-11-26 10:41:15','2024-04-29 05:34:32'),(108,NULL,'geema','golu','gh',67,NULL,120,NULL,NULL,NULL,NULL,'daf@ddd.com','$2b$10$LVX2lb431ihzEsOtm6x/ROCNQWAP7lsFIhSq8kJl5k1cH2UjOyNAa',NULL,NULL,NULL,NULL,0,'email','general_user','Free',NULL,NULL,NULL,'0','0',NULL,1,'2024-02-29 19:42:25','2024-02-26 12:25:14','2024-02-29 19:42:25'),(109,NULL,'arman','arman','khan',32,NULL,138,NULL,NULL,'2024-01-16 18:00:00',NULL,'arman.khan.dev@gmail.com','$2b$10$a.2MqcV5L1XlcROdV2dpDOvzO9in9wMCZX2rEWiAPHP9759PgWQx.',NULL,NULL,NULL,NULL,0,'email','general_user','Premium',NULL,NULL,NULL,'1','0',NULL,0,NULL,'2024-02-29 19:18:23','2024-02-29 19:26:14'),(111,NULL,'new','asdf','asdf',32,NULL,156,NULL,NULL,NULL,NULL,'selimrezaibsnal@gmail.com','$2b$10$9JfP0NVEb0RMso5o/babx.K9M0m3gpcZivxe1HF9hlGd3jeap1T6a',NULL,NULL,NULL,NULL,0,'email','general_user','Premium',NULL,NULL,NULL,'1','0',NULL,0,NULL,'2024-03-07 16:13:20','2024-03-08 18:07:34'),(112,NULL,'arakadld','asdfaf','adfadf',32,NULL,NULL,NULL,NULL,NULL,NULL,'selimrezaibssanal@gmfail.com','$2b$10$zA0UMUDVRiQKQ8vORca8x.V2zRjkdIc0ipT5KKnJ3qXCWBl.mUsnm',NULL,NULL,NULL,NULL,0,'email','general_user','Free',NULL,NULL,NULL,'0','0',NULL,0,NULL,'2024-03-09 15:58:04','2024-03-09 15:58:04');
...
INSERT INTO `video` VALUES (1,'{\"bn\": \"ধূমপান এবং অ্যালকোহল গর্ভাবস্থায় আপনার শিশুর জন্য ক্ষতিকর।\", \"en\": \"Smoking and alcohol are harmful to your baby during pregnancy.\"}','{\"bn\": \"ধূমপান এবং অ্যালকোহল গর্ভাবস্থায় আপনার শিশুর জন্য ক্ষতিকর।\", \"en\": \"Smoking and alcohol are harmful to your baby during pregnancy.\"}','',NULL,'05:30',NULL,NULL,14,'2024-01-09 16:52:38','0000-00-00 00:00:00'),(3,'{\"en\":\"asdfa\"}','{\"en\":\"asefadf\"}','yt',NULL,'23:42','https://media.geeksforgeeks.org/wp-content/uploads/20191111161536/Screenshot-from-2019-11-11-16-13-18.png','https://media.geeksforgeeks.org/wp-content/uploads/20191111161536/Screenshot-from-2019-11-11-16-13-18.png',176,'2024-03-25 18:33:03','2024-03-25 18:33:03');
...
INSERT INTO `weight_logs` VALUES (1,39,NULL,NULL,0,'2023-12-25 10:45:23','2023-12-25 10:45:23'),(2,12,'2024-04-19 12:00:00',70.5,155,'2024-04-29 10:11:02','2024-04-29 10:11:02');
...
-- Dump completed on 2024-04-30 14:25:49
